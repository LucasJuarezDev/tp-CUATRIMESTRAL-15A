<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModificarCategoria.aspx.cs" Inherits="Dominio.ModificarCategoria" %>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content shadow">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" onclick="window.location='Categorias.aspx';"></button>
                    </div>
                    ...
                    <div class="modal-footer">                                                             
                        <button type="button" class="btn btn-secondary" onclick="window.location='Categorias.aspx';">Cerrar</button>
